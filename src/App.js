...
import AdminDetails from "./Main_Admin/Masters/Admin_Dashboard/AdminDetails.jsx";
import AdminpendingStudent from "./Main_Admin/Masters/Admin_Dashboard/AdminpendingStudent.jsx";
import Adminverifiedlist from "./Main_Admin/Masters/Adminverifiedlist.jsx";
import StuPending from "./Main_Admin/Masters/Admin_Dashboard/StuPending.jsx";
import StuVerify from "./Main_Admin/Masters/Admin_Dashboard/StuVerify.jsx";
import Coursechange from "./Main_Admin/Masters/Admin_Dashboard/Coursechange.jsx";
import FeesChange from "./Main_Admin/Masters/Admin_Dashboard/FeesChange.jsx";
import Updatefees from "./Main_Admin/Masters/Admin_Dashboard/Updatefees.jsx";
...
{/* 
        ...
        <Route path="/Epravesh/verified/student" element={<E_approve />}></Route>
        <Route path="/Adminpendingstudentlist" element={<AdminpendingStudent />}></Route>
        <Route path="/Adminverifiedstudentlist" element={<Adminverifiedlist />}></Route>
        <Route path="/stupending" element={<StuPending />}></Route>
        <Route path="/stuverify" element={<StuVerify />}></Route>
        ...
        <Route path='/admindetails' element={<PrivateRoute element={<AdminDetails />} />} />
        <Route path='/coursechange' element={<PrivateRoute element={<Coursechange />} />} />
        <Route path='/feeschange' element={<PrivateRoute element={<FeesChange />} />} />
